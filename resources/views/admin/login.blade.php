        ...
        <div class="mx-auto flex min-h-screen max-w-6xl items-center justify-center px-6 py-12">
            <div class="w-full max-w-md rounded-3xl border border-[#eddad2] bg-white p-8 shadow-[0_20px_60px_rgba(70,40,35,0.15)]">
                <div class="mb-6">
                    ...
                    <h1 class="mt-2 text-3xl font-semibold">Masuk Dashboard</h1>
                    <p class="mt-2 text-sm text-[#7c6f6a]">Gunakan username <span class="font-semibold">admin</span> dan password <span class="font-semibold">admin123</span>.</p>
                </div>
                ...
                <div class="mt-6 text-center text-xs text-[#7c6f6a]">
                    Belum ada akun admin? <a href="/admin/signup" class="font-semibold text-[#991612]">Daftar di sini</a>
                </div>
            </div>
        </div>
    </body>
