            ...
            <div className="mx-auto flex min-h-screen max-w-6xl items-center justify-center px-6 py-12">
                <div className="w-full max-w-md rounded-3xl border border-[#eddad2] bg-white p-8 shadow-[0_20px_60px_rgba(70,40,35,0.15)]">
                    <div className="mb-6">
                        ...
                        <h1 className="mt-2 text-3xl font-semibold">Buat Akun Admin</h1>
                        <p className="mt-2 text-sm text-[#7c6f6a]">
                            Akun admin sementara: username <span className="font-semibold">admin</span> dan password <span className="font-semibold">admin123</span>.
                        </p>
                    </div>
                    ...
                    <div className="mt-6 text-center text-xs text-[#7c6f6a]">
                        Sudah punya akun? <Link href="/admin/login" className="font-semibold text-[#991612]">Masuk di sini</Link>
                    </div>
                </div>
            </div>
        </div>
